...
function Login() {
  ...
  return (
    <div className='container' onSubmit={()=>{handleClick(credentials.email, credentials.password)}}>
        ...
        <form className='my-5'>
            ...
            <div className="form-group my-3 mx-4">
                ...
                <input type="password" className="form-control" id="password" placeholder="Password" value={credentials.password}/>
            </div>
