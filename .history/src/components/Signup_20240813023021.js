    ...
    <div className='container'>
        ...
        <form className='my-5' onSubmit={handleSubmit}>
            ...
            <div className="form-group my-3 mx-4">
                ...
                <input name='cpassword' id='cpassword' onChange={onChange} value={credentials.cpassword} type="password" className="form-control" placeholder="Re-Enter your Password"/>
            </div>
