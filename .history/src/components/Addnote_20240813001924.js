    ...
    <div>
      <div className='container my-3'>
        ...
        <div className="input-group input-group-lg my-3">
          ...
          <input id="title" name="title" type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" onChange={onChange} value={note.title} minLength={[5]}/>
        </div>
        <div className="input-group my-3">
          <span className="input-group-text">Description</span>
          <textarea id="description" name="description" className="form-control" aria-label="With textarea" onChange={onChange} value={note.description} minLength={[5]}></textarea>
        </div>
