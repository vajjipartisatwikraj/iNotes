  ...
  return (
    <div className='container' onSubmit={handleSubmit}>
        ...
        <form className='my-5'>
            ...
            <div className="form-group my-3 mx-4">
                <label  name="password" htmlFor="exampleInputPassword1">Password</label>
                <input type="password" className="form-control" id="password" placeholder="Password" onChange={onChange} value={credentials.password}/>
            </div>
