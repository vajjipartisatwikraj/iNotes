        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="form-group my-3 mx-4">
                ...
                <input id="etitle" name="etitle" type="text" className="form-control" onChange={onChange} value={note.etitle} minLength={[5]}/>
            </div>
            <div className="form-group my-3 mx-4">
                <label htmlFor="exampleInputEmail1">Description</label>
                <input id="edescription" name="edescription" type="text" className="form-control" onChange={onChange} value={note.edescription} minLength={[5]}/>
            </div>
            <div className="form-group my-3 mx-4">
