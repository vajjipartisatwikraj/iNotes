...
function Notes() {
  ...
  //useSate hook
  const [note, setNote] = useState({id:"", etitle: "", edescription: "", etag: ""}) //To maintain input fields empty after and before adding DATA
  ...
  const handleClick=(e)=>{
    ...
    editNote(note.id, note.etitle, note.edescription, note.etag) //using context prop - {editNote} from noteContext
  }
